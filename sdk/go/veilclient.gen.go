...
// PostApiProtocolsProtocolRoomJSONBody defines parameters for PostApiProtocolsProtocolRoom.
type PostApiProtocolsProtocolRoomJSONBody struct {
	// Provider Provider name (e.g. jitsi). Defaults to the protocol default when omitted.
	Provider *string `json:"provider,omitempty"`
}

// PostApiProtocolsProtocolRoomParams defines parameters for PostApiProtocolsProtocolRoom.
type PostApiProtocolsProtocolRoomParams struct {
	// IdempotencyKey Optional replay key for create, update, and destructive operations. Reuse with a different payload returns 409.
	IdempotencyKey *IdempotencyKey `json:"Idempotency-Key,omitempty"`
}
...
// PostApiProtocolsProtocolRoomJSONRequestBody defines body for PostApiProtocolsProtocolRoom for application/json ContentType.
type PostApiProtocolsProtocolRoomJSONRequestBody PostApiProtocolsProtocolRoomJSONBody
...
type ClientInterface interface {
	...
	// PostApiProtocolsProtocolRoomWithBody Generate a room id for a protocol that supports automatic room creation
	//
	...
	// Takes any type of body and a specified content type.
	//
	// Corresponds with POST /api/protocols/{protocol}/room (the `PostApiProtocolsProtocolRoom` operationId).
	PostApiProtocolsProtocolRoomWithBody(ctx context.Context, protocol string, params *PostApiProtocolsProtocolRoomParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	// PostApiProtocolsProtocolRoom Generate a room id for a protocol that supports automatic room creation
	//
	// Returns a fresh room id for the given provider. Only protocols that implement a room generator expose this route; unknown protocols return 404 and providers that require a manually created room return 400.
	//
	// Takes a body of the `application/json` content type.
	//
	// Corresponds with POST /api/protocols/{protocol}/room (the `PostApiProtocolsProtocolRoom` operationId).
	PostApiProtocolsProtocolRoom(ctx context.Context, protocol string, params *PostApiProtocolsProtocolRoomParams, body PostApiProtocolsProtocolRoomJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
	...
	// GetRuntimeProvenance Get verified installed runtime provenance
	//
	// Corresponds with GET /api/runtime/provenance (the `GetRuntimeProvenance` operationId).
	GetRuntimeProvenance(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error)
...
//
// Corresponds with POST /api/protocols/{protocol}/room (the `PostApiProtocolsProtocolRoom` operationId).
func (c *Client) PostApiProtocolsProtocolRoomWithBody(ctx context.Context, protocol string, params *PostApiProtocolsProtocolRoomParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewPostApiProtocolsProtocolRoomRequestWithBody(c.Server, protocol, params, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
//
// Corresponds with POST /api/protocols/{protocol}/room (the `PostApiProtocolsProtocolRoom` operationId).
func (c *Client) PostApiProtocolsProtocolRoom(ctx context.Context, protocol string, params *PostApiProtocolsProtocolRoomParams, body PostApiProtocolsProtocolRoomJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewPostApiProtocolsProtocolRoomRequest(c.Server, protocol, params, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
//
// Corresponds with GET /api/runtime/provenance (the `GetRuntimeProvenance` operationId).
func (c *Client) GetRuntimeProvenance(ctx context.Context, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewGetRuntimeProvenanceRequest(c.Server)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewPostApiProtocolsProtocolRoomRequest calls the generic PostApiProtocolsProtocolRoom builder with application/json body
func NewPostApiProtocolsProtocolRoomRequest(server string, protocol string, params *PostApiProtocolsProtocolRoomParams, body PostApiProtocolsProtocolRoomJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewPostApiProtocolsProtocolRoomRequestWithBody(server, protocol, params, "application/json", bodyReader)
}

// NewPostApiProtocolsProtocolRoomRequestWithBody constructs an http.Request for the PostApiProtocolsProtocolRoom method, with any body, and a specified content type
func NewPostApiProtocolsProtocolRoomRequestWithBody(server string, protocol string, params *PostApiProtocolsProtocolRoomParams, contentType string, body io.Reader) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/api/protocols/%s/room", pathParam0)
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
// NewGetRuntimeProvenanceRequest constructs an http.Request for the GetRuntimeProvenance method
func NewGetRuntimeProvenanceRequest(server string) (*http.Request, error) {
	var err error
	...
	operationPath := fmt.Sprintf("/api/runtime/provenance")
	if operationPath[0] == '/' {
		operationPath = "." + operationPath
	}
...
type ClientWithResponsesInterface interface {
	...
	// PostApiProtocolsProtocolRoomWithBodyWithResponse Generate a room id for a protocol that supports automatic room creation
	//
	// Returns a fresh room id for the given provider. Only protocols that implement a room generator expose this route; unknown protocols return 404 and providers that require a manually created room return 400.
	//
	// Takes any type of body and a specified content type, and returns a wrapper object for the known response body format(s).
	//
	// Corresponds with POST /api/protocols/{protocol}/room (the `PostApiProtocolsProtocolRoom` operationId).
	PostApiProtocolsProtocolRoomWithBodyWithResponse(ctx context.Context, protocol string, params *PostApiProtocolsProtocolRoomParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PostApiProtocolsProtocolRoomResponse, error)

	// PostApiProtocolsProtocolRoomWithResponse Generate a room id for a protocol that supports automatic room creation
	//
	// Returns a fresh room id for the given provider. Only protocols that implement a room generator expose this route; unknown protocols return 404 and providers that require a manually created room return 400.
	//
	// Takes a body of the `application/json` content type, and returns a wrapper object for the known response body format(s).
	//
	// Corresponds with POST /api/protocols/{protocol}/room (the `PostApiProtocolsProtocolRoom` operationId).
	PostApiProtocolsProtocolRoomWithResponse(ctx context.Context, protocol string, params *PostApiProtocolsProtocolRoomParams, body PostApiProtocolsProtocolRoomJSONRequestBody, reqEditors ...RequestEditorFn) (*PostApiProtocolsProtocolRoomResponse, error)
	...
	// GetRuntimeProvenanceWithResponse Get verified installed runtime provenance
	//
	// Returns a wrapper object for the known response body format(s).
	//
	// Corresponds with GET /api/runtime/provenance (the `GetRuntimeProvenance` operationId).
	GetRuntimeProvenanceWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*GetRuntimeProvenanceResponse, error)
...
func (r PostApiAdminRotateKeyResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r PostApiAdminRotateKeyResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r PostApiAdminRotateKeyResponse) GetJSON423() *Locked {
	return r.JSON423
}
...
func (r PostApiAdminRotateKeyResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r PostApiApplyResponse) GetJSON409() *Conflict {
	return r.JSON409
}
...
// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r PostApiApplyResponse) GetJSON423() *Locked {
	return r.JSON423
}

// GetJSON503 returns the response for an HTTP 503 `application/json` response
func (r PostApiApplyResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r PostApiApplyJobsIdRetryResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r PostApiApplyJobsIdRetryResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r PostApiApplyJobsIdRetryResponse) GetJSON423() *Locked {
	return r.JSON423
}

// GetJSON503 returns the response for an HTTP 503 `application/json` response
func (r PostApiApplyJobsIdRetryResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r PostApiApplyPlanResponse) GetJSON409() *Conflict {
	return r.JSON409
}
...
// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r PostApiApplyPlanResponse) GetJSON423() *Locked {
	return r.JSON423
}

// GetJSON503 returns the response for an HTTP 503 `application/json` response
func (r PostApiApplyPlanResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r PostApiApplyReconcileResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r PostApiApplyReconcileResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r PostApiApplyReconcileResponse) GetJSON423() *Locked {
	return r.JSON423
}

// GetJSON503 returns the response for an HTTP 503 `application/json` response
func (r PostApiApplyReconcileResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r PostApiApplyRollbackResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r PostApiApplyRollbackResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r PostApiApplyRollbackResponse) GetJSON423() *Locked {
	return r.JSON423
}

// GetJSON503 returns the response for an HTTP 503 `application/json` response
func (r PostApiApplyRollbackResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r PostApiAuthLocaleResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r PostApiAuthLocaleResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r PostApiAuthLocaleResponse) GetJSON423() *Locked {
	return r.JSON423
}

// GetJSON503 returns the response for an HTTP 503 `application/json` response
func (r PostApiAuthLocaleResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r PostApiAuthLoginResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r PostApiAuthLoginResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r PostApiAuthLoginResponse) GetJSON423() *Locked {
	return r.JSON423
}

// GetJSON503 returns the response for an HTTP 503 `application/json` response
func (r PostApiAuthLoginResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r PostApiAuthLogoutResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r PostApiAuthLogoutResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r PostApiAuthLogoutResponse) GetJSON423() *Locked {
	return r.JSON423
}

// GetJSON503 returns the response for an HTTP 503 `application/json` response
func (r PostApiAuthLogoutResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r DeleteApiAuthSessionsResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r DeleteApiAuthSessionsResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r DeleteApiAuthSessionsResponse) GetJSON423() *Locked {
	return r.JSON423
}

// GetJSON503 returns the response for an HTTP 503 `application/json` response
func (r DeleteApiAuthSessionsResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r PostApiBackupsResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r PostApiBackupsResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r PostApiBackupsResponse) GetJSON423() *Locked {
	return r.JSON423
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r PostApiBackupsPruneResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r PostApiBackupsPruneResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r PostApiBackupsPruneResponse) GetJSON423() *Locked {
	return r.JSON423
}

// GetJSON503 returns the response for an HTTP 503 `application/json` response
func (r PostApiBackupsPruneResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r PostApiBackupsNameRestoreResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r PostApiBackupsNameRestoreResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r PostApiBackupsNameRestoreResponse) GetJSON423() *Locked {
	return r.JSON423
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r PostApiBackupsNameVerifyResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r PostApiBackupsNameVerifyResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r PostApiBackupsNameVerifyResponse) GetJSON423() *Locked {
	return r.JSON423
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r PostApiClientLinksQrResponse) GetJSON409() *Conflict {
	return r.JSON409
}
...
// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r PostApiClientLinksQrResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r PostApiClientLinksQrResponse) GetJSON423() *Locked {
	return r.JSON423
}

// GetJSON503 returns the response for an HTTP 503 `application/json` response
func (r PostApiClientLinksQrResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r PostApiInboundsResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r PostApiInboundsResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r PostApiInboundsResponse) GetJSON423() *Locked {
	return r.JSON423
}

// GetJSON503 returns the response for an HTTP 503 `application/json` response
func (r PostApiInboundsResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r DeleteApiInboundsNameResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r DeleteApiInboundsNameResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r DeleteApiInboundsNameResponse) GetJSON423() *Locked {
	return r.JSON423
}

// GetJSON503 returns the response for an HTTP 503 `application/json` response
func (r DeleteApiInboundsNameResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r PutApiInboundsNameResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r PutApiInboundsNameResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r PutApiInboundsNameResponse) GetJSON423() *Locked {
	return r.JSON423
}

// GetJSON503 returns the response for an HTTP 503 `application/json` response
func (r PutApiInboundsNameResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r PostApiProfilesRuRecommendedPreviewResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r PostApiProfilesRuRecommendedPreviewResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r PostApiProfilesRuRecommendedPreviewResponse) GetJSON423() *Locked {
	return r.JSON423
}

// GetJSON503 returns the response for an HTTP 503 `application/json` response
func (r PostApiProfilesRuRecommendedPreviewResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}
...
// PostApiProtocolsProtocolRoomResponse401Headers the declared response headers of an HTTP 401 response for PostApiProtocolsProtocolRoom
type PostApiProtocolsProtocolRoomResponse401Headers struct {
	WWWAuthenticate *string
}

type PostApiProtocolsProtocolRoomResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	// JSON200 the response for an HTTP 200 `application/json` response
	JSON200 *struct {
	...
	JSON403 *Forbidden
	// Headers401 the parsed response headers for an HTTP 401 response
	Headers401 *PostApiProtocolsProtocolRoomResponse401Headers
}

// GetJSON200 returns the response for an HTTP 200 `application/json` response
func (r PostApiProtocolsProtocolRoomResponse) GetJSON200() *struct {
	Provider string `json:"provider"`
	RoomID   string `json:"roomID"`
} {
	return r.JSON200
...
// GetJSON401 returns the response for an HTTP 401 `application/json` response
func (r PostApiProtocolsProtocolRoomResponse) GetJSON401() *Unauthorized {
	return r.JSON401
}

// GetJSON403 returns the response for an HTTP 403 `application/json` response
func (r PostApiProtocolsProtocolRoomResponse) GetJSON403() *Forbidden {
	return r.JSON403
}

// GetBody returns the raw response body bytes
func (r PostApiProtocolsProtocolRoomResponse) GetBody() []byte {
	return r.Body
}

// Status returns HTTPResponse.Status
func (r PostApiProtocolsProtocolRoomResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r PostApiProtocolsProtocolRoomResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r PostApiProtocolsProtocolRoomResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r PostApiRoutingPresetsNameResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r PostApiRoutingPresetsNameResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r PostApiRoutingPresetsNameResponse) GetJSON423() *Locked {
	return r.JSON423
}

// GetJSON503 returns the response for an HTTP 503 `application/json` response
func (r PostApiRoutingPresetsNameResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r PostApiRoutingRulesResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r PostApiRoutingRulesResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r PostApiRoutingRulesResponse) GetJSON423() *Locked {
	return r.JSON423
}

// GetJSON503 returns the response for an HTTP 503 `application/json` response
func (r PostApiRoutingRulesResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r DeleteApiRoutingRulesNameResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r DeleteApiRoutingRulesNameResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r DeleteApiRoutingRulesNameResponse) GetJSON423() *Locked {
	return r.JSON423
}

// GetJSON503 returns the response for an HTTP 503 `application/json` response
func (r DeleteApiRoutingRulesNameResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r PutApiRoutingRulesNameResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r PutApiRoutingRulesNameResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r PutApiRoutingRulesNameResponse) GetJSON423() *Locked {
	return r.JSON423
}

// GetJSON503 returns the response for an HTTP 503 `application/json` response
func (r PutApiRoutingRulesNameResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}
...
// GetJSON503 returns the response for an HTTP 503 `application/json` response
func (r GetRuntimeProvenanceResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}

// GetBody returns the raw response body bytes
func (r GetRuntimeProvenanceResponse) GetBody() []byte {
	return r.Body
}

// Status returns HTTPResponse.Status
func (r GetRuntimeProvenanceResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r GetRuntimeProvenanceResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// ContentType is a convenience method to retrieve the Content-Type value from the HTTP response headers
func (r GetRuntimeProvenanceResponse) ContentType() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Header.Get("Content-Type")
	}
	return ""
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r PostApiServicesNameRestartResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r PostApiServicesNameRestartResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r PostApiServicesNameRestartResponse) GetJSON423() *Locked {
	return r.JSON423
}
...
// GetJSON503 returns the response for an HTTP 503 `application/json` response
func (r PostApiServicesNameRestartResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r PutApiSettingsResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r PutApiSettingsResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r PutApiSettingsResponse) GetJSON423() *Locked {
	return r.JSON423
}

// GetJSON503 returns the response for an HTTP 503 `application/json` response
func (r PutApiSettingsResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r PostApiSetupCompleteResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r PostApiSetupCompleteResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r PostApiSetupCompleteResponse) GetJSON423() *Locked {
	return r.JSON423
}

// GetJSON503 returns the response for an HTTP 503 `application/json` response
func (r PostApiSetupCompleteResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r PostApiToolsDnsLookupResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r PostApiToolsDnsLookupResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r PostApiToolsDnsLookupResponse) GetJSON423() *Locked {
	return r.JSON423
}

// GetJSON503 returns the response for an HTTP 503 `application/json` response
func (r PostApiToolsDnsLookupResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r PostApiToolsPingResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r PostApiToolsPingResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r PostApiToolsPingResponse) GetJSON423() *Locked {
	return r.JSON423
}

// GetJSON503 returns the response for an HTTP 503 `application/json` response
func (r PostApiToolsPingResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r PostApiToolsSpeedtestResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r PostApiToolsSpeedtestResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r PostApiToolsSpeedtestResponse) GetJSON423() *Locked {
	return r.JSON423
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r PostApiUsersResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r PostApiUsersResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r PostApiUsersResponse) GetJSON423() *Locked {
	return r.JSON423
}

// GetJSON503 returns the response for an HTTP 503 `application/json` response
func (r PostApiUsersResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r DeleteApiUsersUsernameResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r DeleteApiUsersUsernameResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r DeleteApiUsersUsernameResponse) GetJSON423() *Locked {
	return r.JSON423
}

// GetJSON503 returns the response for an HTTP 503 `application/json` response
func (r DeleteApiUsersUsernameResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r PutApiUsersUsernameResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r PutApiUsersUsernameResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r PutApiUsersUsernameResponse) GetJSON423() *Locked {
	return r.JSON423
}

// GetJSON503 returns the response for an HTTP 503 `application/json` response
func (r PutApiUsersUsernameResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}
...
// PostApiV1ClientsResponse201Headers the declared response headers of an HTTP 201 response for PostApiV1Clients
type PostApiV1ClientsResponse201Headers struct {
...
type PostApiV1ClientsResponse struct {
	...
	Headers201 *PostApiV1ClientsResponse201Headers
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r PostApiV1ClientsResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r PostApiV1ClientsResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r PostApiV1ClientsResponse) GetJSON423() *Locked {
	return r.JSON423
}

// GetJSON503 returns the response for an HTTP 503 `application/json` response
func (r PostApiV1ClientsResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r PostApiV1ClientsBulkResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r PostApiV1ClientsBulkResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r PostApiV1ClientsBulkResponse) GetJSON423() *Locked {
	return r.JSON423
}

// GetJSON503 returns the response for an HTTP 503 `application/json` response
func (r PostApiV1ClientsBulkResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r PostApiV1ClientsMigrateLegacyResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r PostApiV1ClientsMigrateLegacyResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r PostApiV1ClientsMigrateLegacyResponse) GetJSON423() *Locked {
	return r.JSON423
}

// GetJSON503 returns the response for an HTTP 503 `application/json` response
func (r PostApiV1ClientsMigrateLegacyResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r DeleteApiV1ClientsIdResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r DeleteApiV1ClientsIdResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r DeleteApiV1ClientsIdResponse) GetJSON423() *Locked {
	return r.JSON423
}

// GetJSON503 returns the response for an HTTP 503 `application/json` response
func (r DeleteApiV1ClientsIdResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}
...
// PatchApiV1ClientsIdResponse200Headers the declared response headers of an HTTP 200 response for PatchApiV1ClientsId
type PatchApiV1ClientsIdResponse200Headers struct {
	ETag                *string
	IdempotencyReplayed *bool
}
...
type PatchApiV1ClientsIdResponse struct {
	...
	JSON503 *ServiceUnavailable
	// Headers200 the parsed response headers for an HTTP 200 response
	Headers200 *PatchApiV1ClientsIdResponse200Headers
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r PatchApiV1ClientsIdResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r PatchApiV1ClientsIdResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r PatchApiV1ClientsIdResponse) GetJSON423() *Locked {
	return r.JSON423
}

// GetJSON503 returns the response for an HTTP 503 `application/json` response
func (r PatchApiV1ClientsIdResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r PostApiV1ClientsIdBindingsResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r PostApiV1ClientsIdBindingsResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r PostApiV1ClientsIdBindingsResponse) GetJSON423() *Locked {
	return r.JSON423
}

// GetJSON503 returns the response for an HTTP 503 `application/json` response
func (r PostApiV1ClientsIdBindingsResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r DeleteApiV1ClientsIdBindingsBindingIdResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r DeleteApiV1ClientsIdBindingsBindingIdResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r DeleteApiV1ClientsIdBindingsBindingIdResponse) GetJSON423() *Locked {
	return r.JSON423
}

// GetJSON503 returns the response for an HTTP 503 `application/json` response
func (r DeleteApiV1ClientsIdBindingsBindingIdResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r PatchApiV1ClientsIdBindingsBindingIdResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r PatchApiV1ClientsIdBindingsBindingIdResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r PatchApiV1ClientsIdBindingsBindingIdResponse) GetJSON423() *Locked {
	return r.JSON423
}

// GetJSON503 returns the response for an HTTP 503 `application/json` response
func (r PatchApiV1ClientsIdBindingsBindingIdResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r PostApiV1ClientsIdCredentialsBindingIdResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r PostApiV1ClientsIdCredentialsBindingIdResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r PostApiV1ClientsIdCredentialsBindingIdResponse) GetJSON423() *Locked {
	return r.JSON423
}

// GetJSON503 returns the response for an HTTP 503 `application/json` response
func (r PostApiV1ClientsIdCredentialsBindingIdResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r PostApiV1ClientsIdCredentialsBindingIdRotateResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r PostApiV1ClientsIdCredentialsBindingIdRotateResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r PostApiV1ClientsIdCredentialsBindingIdRotateResponse) GetJSON423() *Locked {
	return r.JSON423
}

// GetJSON503 returns the response for an HTTP 503 `application/json` response
func (r PostApiV1ClientsIdCredentialsBindingIdRotateResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r PostApiV1ClientsIdTokensResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r PostApiV1ClientsIdTokensResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r PostApiV1ClientsIdTokensResponse) GetJSON423() *Locked {
	return r.JSON423
}

// GetJSON503 returns the response for an HTTP 503 `application/json` response
func (r PostApiV1ClientsIdTokensResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r DeleteApiV1ClientsIdTokensTokenIdResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r DeleteApiV1ClientsIdTokensTokenIdResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r DeleteApiV1ClientsIdTokensTokenIdResponse) GetJSON423() *Locked {
	return r.JSON423
}

// GetJSON503 returns the response for an HTTP 503 `application/json` response
func (r DeleteApiV1ClientsIdTokensTokenIdResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r PostApiV1ClientsIdTokensTokenIdRotateResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r PostApiV1ClientsIdTokensTokenIdRotateResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r PostApiV1ClientsIdTokensTokenIdRotateResponse) GetJSON423() *Locked {
	return r.JSON423
}

// GetJSON503 returns the response for an HTTP 503 `application/json` response
func (r PostApiV1ClientsIdTokensTokenIdRotateResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}
...
// GetApiV1EventsResponse200Headers the declared response headers of an HTTP 200 response for GetApiV1Events
type GetApiV1EventsResponse200Headers struct {
	LastEventID *string
}

// GetApiV1EventsResponse429Headers the declared response headers of an HTTP 429 response for GetApiV1Events
type GetApiV1EventsResponse429Headers struct {
	RetryAfter *int
}
...
type GetApiV1EventsResponse struct {
	...
	HTTPResponse *http.Response
	// Headers200 the parsed response headers for an HTTP 200 response
	Headers200 *GetApiV1EventsResponse200Headers
	// Headers429 the parsed response headers for an HTTP 429 response
	Headers429 *GetApiV1EventsResponse429Headers
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r PostApiValidationResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r PostApiValidationResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r PostApiValidationResponse) GetJSON423() *Locked {
	return r.JSON423
}

// GetJSON503 returns the response for an HTTP 503 `application/json` response
func (r PostApiValidationResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r PostApiVersionUpdateResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r PostApiVersionUpdateResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r PostApiVersionUpdateResponse) GetJSON423() *Locked {
	return r.JSON423
}
...
// GetJSON409 returns the response for an HTTP 409 `application/json` response
func (r PutApiWarpResponse) GetJSON409() *Conflict {
	return r.JSON409
}

// GetJSON422 returns the response for an HTTP 422 `application/json` response
func (r PutApiWarpResponse) GetJSON422() *ValidationFailed {
	return r.JSON422
}

// GetJSON423 returns the response for an HTTP 423 `application/json` response
func (r PutApiWarpResponse) GetJSON423() *Locked {
	return r.JSON423
}

// GetJSON503 returns the response for an HTTP 503 `application/json` response
func (r PutApiWarpResponse) GetJSON503() *ServiceUnavailable {
	return r.JSON503
}
...
//
// Corresponds with POST /api/protocols/{protocol}/room (the `PostApiProtocolsProtocolRoom` operationId).
func (c *ClientWithResponses) PostApiProtocolsProtocolRoomWithBodyWithResponse(ctx context.Context, protocol string, params *PostApiProtocolsProtocolRoomParams, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*PostApiProtocolsProtocolRoomResponse, error) {
	rsp, err := c.PostApiProtocolsProtocolRoomWithBody(ctx, protocol, params, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParsePostApiProtocolsProtocolRoomResponse(rsp)
}
...
//
// Corresponds with POST /api/protocols/{protocol}/room (the `PostApiProtocolsProtocolRoom` operationId).
func (c *ClientWithResponses) PostApiProtocolsProtocolRoomWithResponse(ctx context.Context, protocol string, params *PostApiProtocolsProtocolRoomParams, body PostApiProtocolsProtocolRoomJSONRequestBody, reqEditors ...RequestEditorFn) (*PostApiProtocolsProtocolRoomResponse, error) {
	rsp, err := c.PostApiProtocolsProtocolRoom(ctx, protocol, params, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParsePostApiProtocolsProtocolRoomResponse(rsp)
...
//
// Corresponds with GET /api/runtime/provenance (the `GetRuntimeProvenance` operationId).
func (c *ClientWithResponses) GetRuntimeProvenanceWithResponse(ctx context.Context, reqEditors ...RequestEditorFn) (*GetRuntimeProvenanceResponse, error) {
	rsp, err := c.GetRuntimeProvenance(ctx, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseGetRuntimeProvenanceResponse(rsp)
}
...
// ParsePostApiProtocolsProtocolRoomResponse parses an HTTP response from a PostApiProtocolsProtocolRoomWithResponse call
func ParsePostApiProtocolsProtocolRoomResponse(rsp *http.Response) (*PostApiProtocolsProtocolRoomResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &PostApiProtocolsProtocolRoomResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
	...
	switch {
	case rsp.StatusCode == 401:
		var headers PostApiProtocolsProtocolRoomResponse401Headers
		if values := rsp.Header.Values("WWW-Authenticate"); len(values) > 0 {
			var value string
			if err := runtime.BindStyledParameterWithOptions("simple", "WWW-Authenticate", values[0], &value, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationHeader, Explode: false, Required: false, Type: "string", Format: ""}); err != nil {
				return nil, err
...
// ParseGetRuntimeProvenanceResponse parses an HTTP response from a GetRuntimeProvenanceWithResponse call
func ParseGetRuntimeProvenanceResponse(rsp *http.Response) (*GetRuntimeProvenanceResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &GetRuntimeProvenanceResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
...
func ParsePostApiV1ClientsResponse(rsp *http.Response) (*PostApiV1ClientsResponse, error) {
	...
	case rsp.StatusCode == 201:
		var headers PostApiV1ClientsResponse201Headers
...
func ParsePatchApiV1ClientsIdResponse(rsp *http.Response) (*PatchApiV1ClientsIdResponse, error) {
	...
	switch {
	case rsp.StatusCode == 200:
		var headers PatchApiV1ClientsIdResponse200Headers
...
func ParseGetApiV1EventsResponse(rsp *http.Response) (*GetApiV1EventsResponse, error) {
	...
	switch {
	case rsp.StatusCode == 200:
		var headers GetApiV1EventsResponse200Headers
		if values := rsp.Header.Values("Last-Event-ID"); len(values) > 0 {
			var value string
			if err := runtime.BindStyledParameterWithOptions("simple", "Last-Event-ID", values[0], &value, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationHeader, Explode: false, Required: false, Type: "string", Format: ""}); err != nil {
				return nil, err
			}
	...
	case rsp.StatusCode == 429:
		var headers GetApiV1EventsResponse429Headers
