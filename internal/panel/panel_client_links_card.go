...
func panelClientLinksCardHTML() string {
    ...
    <div class="card">
      ...
      <pre id="client-links-output" role="status" aria-live="polite" style="margin-top: 16px;">Not loaded</pre>
    </div>

    <!-- Interactive Client Links Modal -->
    <div id="client-links-modal-overlay" class="modal-overlay" aria-hidden="true">
      <div class="modal-content" style="max-width: 650px;" role="dialog" aria-modal="true" aria-labelledby="client-links-modal-title" tabindex="-1">
        <div class="modal-header">
          <h2 id="client-links-modal-title">Client Connection Links</h2>
          <button type="button" class="modal-close" aria-label="Close dialog" onclick="closeClientLinksModal()">&times;</button>
        </div>
