...
func TestCatalogAssetMatchersMatchUpstreamNames(t *testing.T) {
	...
	if sb.AssetMatch == nil || !sb.AssetMatch("sing-box-1.14.0-linux-amd64.tar.gz") {
...
func TestSingBoxMatcherRejectsMuslAndGlibcVariants(t *testing.T) {
	...
	if !sb.AssetMatch("sing-box-1.14.0-linux-amd64.tar.gz") {
...
func TestInstallAllInstallsCatalogRuntimes(t *testing.T) {
	...
	opts := Options{
		BinDir:             binDir,
		Arch:               "amd64",
		RunVersion:         fixedRuntimeVersion("sing-box version 1.14.0"),
		...
		FetchRelease: func(ctx context.Context, repo string) (*Release, error) {
			...
			return &Release{TagName: "v1.14.0", Assets: []Asset{
				{Name: "sing-box-1.14.0-linux-amd64.tar.gz", BrowserDownloadURL: "https://example/sb"},
			}}, nil
		},
		Download: func(ctx context.Context, url string) ([]byte, error) {
