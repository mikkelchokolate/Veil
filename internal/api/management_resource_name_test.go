...
func TestManagementResourceNameParsesSinglePathSegment(t *testing.T) {
	parser := NewManagementResourceName("/api/routing/rules/")
...
func TestManagementResourceNameRejectsEmptyNestedAndWrongPrefix(t *testing.T) {
	parser := NewManagementResourceName("/api/routing/rules/")
