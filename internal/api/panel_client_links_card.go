...
func panelClientLinksCardHTML() string {
	return `    <div class="card">
      <h2>Client links</h2>
      <p>Generate current NaiveProxy, Hysteria2, and Mieru client connection URIs/client config artifacts from saved settings and enabled inbounds through <code>/api/client-links</code>.</p>
