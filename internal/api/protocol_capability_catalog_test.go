...
func TestProtocolCapabilityCatalogCoversMieruEndToEnd(t *testing.T) {
	...
	if capability.GeneratedConfigPath != "/etc/veil/generated/mieru/server_config.json" || capability.ApplyAction != "restart veil-mieru.service" || capability.RuntimeUnit != "veil-mieru.service" {
