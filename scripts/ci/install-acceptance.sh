...
# /healthz is a public root-level probe; the web base path guards the panel API.
health_code="$(curl -sk -o /tmp/ia-health.json -w '%{http_code}' "https://127.0.0.1:${PANEL_PORT}/healthz")"
