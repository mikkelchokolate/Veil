...
- RURecommendedProfile, Veil install/repair workflow inputs, profile preview, Panel settings actions, and Client link responses no longer expose legacy protocol stack/install fields; the remaining legacy stack compatibility Modules are Settings normalization and hidden CLI/script flag rejection.
