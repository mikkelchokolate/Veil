...
export const en: Record<string, string> = {
	...
	"common.error.timeout":
		"The request timed out. Check whether the change was applied before retrying.",
	"common.error.cancelled": "The request was cancelled.",
	...
	"apply.transferredJobsHidden": "{n} transferred recovery jobs hidden",
	"apply.showTransferredJobs": "Show transferred jobs",
	"apply.hideTransferredJobs": "Hide transferred jobs",
	...
	"backups.pruneConfirmTitle": "Prune old backups?",
	"backups.pruneConfirmDescription":
		"Keep {daily} daily, {weekly} weekly, and {monthly} monthly archives. Other managed backups will be deleted.",
	"backups.retentionDaily": "Daily",
	"backups.retentionWeekly": "Weekly",
	"backups.retentionMonthly": "Monthly",
	"backups.confirmPrune": "Confirm prune",
	...
	"subTokens.status.expired": "expired",
	"subTokens.rotateExpiredTitle": "Renew expired token?",
	"subTokens.rotateExpiredDescription":
		"Rotating an expired token requires a new future expiry. It will not become unlimited.",
	...
	"diagnostics.adminRequired": "Requires the admin role.",
	"diagnostics.notStarted": "Not started",
	"diagnostics.audit.title": "Audit log",
	"diagnostics.audit.loadFailed": "Failed to load the audit log",
	"diagnostics.audit.empty": "No audit records.",
	"diagnostics.audit.time": "Time",
	"diagnostics.audit.actor": "Actor",
	"diagnostics.audit.action": "Action",
	"diagnostics.audit.target": "Target",
	"diagnostics.audit.ip": "IP",
	"diagnostics.audit.result": "Result",
	"diagnostics.audit.ok": "ok",
	"diagnostics.audit.failed": "failed",
	"diagnostics.audit.loadOlder": "Load older",
	"diagnostics.logs.title": "Service logs",
	"diagnostics.logs.unit": "Service unit",
	"diagnostics.logs.lines": "Lines",
	"diagnostics.logs.linesInvalid":
		"Lines must be a whole number between 1 and 500.",
	"diagnostics.logs.load": "Load logs",
	"diagnostics.logs.loading": "Loading…",
	"diagnostics.logs.failed": "Failed to load logs",
	"diagnostics.dns.title": "DNS lookup",
	"diagnostics.dns.hostname": "Hostname",
	"diagnostics.dns.run": "Lookup hostname",
	"diagnostics.dns.required": "Hostname is required",
	"diagnostics.dns.failed": "Lookup failed",
	"diagnostics.dns.addresses": "Addresses",
	"diagnostics.dns.cname": "CNAME",
	"diagnostics.dns.none": "No addresses returned.",
	"diagnostics.ping.title": "Ping",
	"diagnostics.ping.host": "Host",
	"diagnostics.ping.count": "Count (1-10)",
	"diagnostics.ping.countInvalid":
		"Count must be a whole number between 1 and 10.",
	"diagnostics.ping.run": "Ping",
	"diagnostics.ping.required": "Host is required",
	"diagnostics.ping.failed": "Ping failed",
	"diagnostics.ping.result": "{received}/{transmitted} received · {loss}% loss",
	"diagnostics.ping.times":
		"min {min} ms · avg {avg} ms · max {max} ms · stddev {stddev} ms",
	"diagnostics.speedtest.title": "Speedtest",
	"diagnostics.speedtest.run": "Run speedtest",
	"diagnostics.speedtest.running": "Running…",
	"diagnostics.speedtest.failed": "Speedtest failed",
	"diagnostics.speedtest.result":
		"Ping {ping} ms · download {download} Mbps · upload {upload} Mbps",
	"diagnostics.firewall.title": "Firewall",
	"diagnostics.firewall.port": "Port",
	"diagnostics.firewall.protocol": "Protocol",
	"diagnostics.firewall.service": "Service",
	"diagnostics.firewall.empty": "No firewall rules.",
	"diagnostics.firewall.failed": "Failed to load firewall rules",
