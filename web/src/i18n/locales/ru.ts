...
export const ru: Record<string, string> = {
	...
	"common.error.timeout":
		"Время запроса истекло. Проверьте, применилось ли изменение, прежде чем повторять.",
	"common.error.cancelled": "Запрос был отменён.",
	...
	"apply.transferredJobsHidden": "{n} перенесённых задач восстановления скрыто",
	"apply.showTransferredJobs": "Показать перенесённые задачи",
	"apply.hideTransferredJobs": "Скрыть перенесённые задачи",
	...
	"backups.pruneConfirmTitle": "Удалить старые бэкапы?",
	"backups.pruneConfirmDescription":
		"Оставить {daily} ежедневных, {weekly} еженедельных и {monthly} ежемесячных архивов. Остальные управляемые бэкапы будут удалены.",
	"backups.retentionDaily": "Ежедневно",
	"backups.retentionWeekly": "Еженедельно",
	"backups.retentionMonthly": "Ежемесячно",
	"backups.confirmPrune": "Подтвердить удаление",
	...
	"subTokens.status.expired": "истёк",
	"subTokens.rotateExpiredTitle": "Продлить истёкший токен?",
	"subTokens.rotateExpiredDescription":
		"Ротация истёкшего токена требует новой даты истечения в будущем. Токен не станет бессрочным.",
	...
	"diagnostics.adminRequired": "Требуется роль администратора.",
	"diagnostics.notStarted": "Не запущено",
	"diagnostics.audit.title": "Журнал аудита",
	"diagnostics.audit.loadFailed": "Не удалось загрузить журнал аудита",
	"diagnostics.audit.empty": "Записей аудита нет.",
	"diagnostics.audit.time": "Время",
	"diagnostics.audit.actor": "Актор",
	"diagnostics.audit.action": "Действие",
	"diagnostics.audit.target": "Цель",
	"diagnostics.audit.ip": "IP",
	"diagnostics.audit.result": "Результат",
	"diagnostics.audit.ok": "ok",
	"diagnostics.audit.failed": "сбой",
	"diagnostics.audit.loadOlder": "Загрузить более ранние",
	"diagnostics.logs.title": "Логи службы",
	"diagnostics.logs.unit": "Unit службы",
	"diagnostics.logs.lines": "Строк",
	"diagnostics.logs.linesInvalid": "Строк должно быть целое число от 1 до 500.",
	"diagnostics.logs.load": "Загрузить логи",
	"diagnostics.logs.loading": "Загрузка…",
	"diagnostics.logs.failed": "Не удалось загрузить логи",
	"diagnostics.dns.title": "DNS-резолв",
	"diagnostics.dns.hostname": "Имя хоста",
	"diagnostics.dns.run": "Резолвить",
	"diagnostics.dns.required": "Укажите имя хоста",
	"diagnostics.dns.failed": "Резолв не удался",
	"diagnostics.dns.addresses": "Адреса",
	"diagnostics.dns.cname": "CNAME",
	"diagnostics.dns.none": "Адресов не возвращено.",
	"diagnostics.ping.title": "Ping",
	"diagnostics.ping.host": "Хост",
	"diagnostics.ping.count": "Количество (1-10)",
	"diagnostics.ping.countInvalid":
		"Количество должно быть целым числом от 1 до 10.",
	"diagnostics.ping.run": "Пинговать",
	"diagnostics.ping.required": "Укажите хост",
	"diagnostics.ping.failed": "Ping не удался",
	"diagnostics.ping.result":
		"{received}/{transmitted} получено · {loss}% потерь",
	"diagnostics.ping.times":
		"min {min} мс · avg {avg} мс · max {max} мс · stddev {stddev} мс",
	"diagnostics.speedtest.title": "Тест скорости",
	"diagnostics.speedtest.run": "Запустить тест скорости",
	"diagnostics.speedtest.running": "Выполняется…",
	"diagnostics.speedtest.failed": "Тест скорости не удался",
	"diagnostics.speedtest.result":
		"Ping {ping} мс · загрузка {download} Мбит/с · отдача {upload} Мбит/с",
	"diagnostics.firewall.title": "Файрвол",
	"diagnostics.firewall.port": "Порт",
	"diagnostics.firewall.protocol": "Протокол",
	"diagnostics.firewall.service": "Служба",
	"diagnostics.firewall.empty": "Нет правил файрвола.",
	"diagnostics.firewall.failed": "Не удалось загрузить правила файрвола",
