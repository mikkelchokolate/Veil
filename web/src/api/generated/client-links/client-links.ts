...
export const getGetApiClientLinksMutationKey = () => ['getApiClientLinks'] as const;
...
const mutationKey = getGetApiClientLinksMutationKey();
...
export const getGetApiClientLinksSubscriptionMutationKey = () => ['getApiClientLinksSubscription'] as const;

export const getGetApiClientLinksSubscriptionMutationOptions = <TError = unknown,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof getApiClientLinksSubscription>>, TError,GetApiClientLinksSubscriptionMutationVariables, TContext>, request?: SecondParameter<typeof apiFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof getApiClientLinksSubscription>>, TError,GetApiClientLinksSubscriptionMutationVariables, TContext> => {

const mutationKey = getGetApiClientLinksSubscriptionMutationKey();
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof getApiClientLinksSubscription>>, GetApiClientLinksSubscriptionMutationVariables> = (props) => {
          const {params} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type GetApiClientLinksSubscriptionMutationVariables = {params?: GetApiClientLinksSubscriptionParams}
...
export const useGetApiClientLinksSubscription = <TError = unknown,
 ...
 , queryClient?: QueryClient): UseMutationResult<
        ...
        TError,
        GetApiClientLinksSubscriptionMutationVariables,
        TContext
      > => {
...
export const getPostApiClientLinksQrQueryOptions = <TData = Awaited<ReturnType<typeof postApiClientLinksQr>>, TError = BadRequestResponse | UnauthorizedResponse | ConflictResponse | ErrorEnvelope | ValidationFailedResponse | LockedResponse | ServiceUnavailableResponse>(clientLinkQRRequest: ClientLinkQRRequest, options?: { query?:Partial<UseQueryOptions<Awaited<ReturnType<typeof postApiClientLinksQr>>, TError, TData>>, request?: SecondParameter<typeof apiFetch>}
) => {
...
export type PostApiClientLinksQrQueryError = BadRequestResponse | UnauthorizedResponse | ConflictResponse | ErrorEnvelope | ValidationFailedResponse | LockedResponse | ServiceUnavailableResponse


export function usePostApiClientLinksQr<TData = Awaited<ReturnType<typeof postApiClientLinksQr>>, TError = BadRequestResponse | UnauthorizedResponse | ConflictResponse | ErrorEnvelope | ValidationFailedResponse | LockedResponse | ServiceUnavailableResponse>(
