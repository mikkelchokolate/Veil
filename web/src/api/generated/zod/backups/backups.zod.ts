...
export const GetApiBackupsResponseItem = zod.object({
  ...
  "size": zod.int().min(getApiBackupsResponseSizeMin),
...
export const PostApiBackupsBody = zod.object({
  ...
  "daily": zod.int().min(postApiBackupsBodyDailyMin).max(postApiBackupsBodyDailyMax).default(postApiBackupsBodyDailyDefault),
  "weekly": zod.int().min(postApiBackupsBodyWeeklyMin).max(postApiBackupsBodyWeeklyMax).default(postApiBackupsBodyWeeklyDefault),
  "monthly": zod.int().min(postApiBackupsBodyMonthlyMin).max(postApiBackupsBodyMonthlyMax).default(postApiBackupsBodyMonthlyDefault)
})
...
export const PostApiBackupsResponse = zod.object({
  ...
  "name": zod.string(),
  "path": zod.string().describe('Absolute server-side archive path.'),
  "size": zod.int().min(postApiBackupsResponseArchiveSizeMin),
  "createdAt": zod.iso.datetime({"offset":true}),
  "encrypted": zod.boolean()
}),
  "verification": zod.object({
  "formatVersion": zod.int().min(postApiBackupsResponseVerificationFormatVersionMin).describe('Zero for legacy archives without a manifest.'),
  ...
  "stateSchemaVersion": zod.int().min(1),
  "desiredRevision": zod.int().min(postApiBackupsResponseVerificationDesiredRevisionMin).describe('Desired configuration revision captured with the state and SQLite snapshot.'),
  "files": zod.array(zod.object({
  "name": zod.enum(['state.json', 'state.key', 'veil.db']),
  "size": zod.int().min(postApiBackupsResponseVerificationFilesItemSizeMin),
...
export const PostApiBackupsPruneBody = zod.object({
  "daily": zod.int().min(postApiBackupsPruneBodyDailyMin).max(postApiBackupsPruneBodyDailyMax).default(postApiBackupsPruneBodyDailyDefault),
  "weekly": zod.int().min(postApiBackupsPruneBodyWeeklyMin).max(postApiBackupsPruneBodyWeeklyMax).default(postApiBackupsPruneBodyWeeklyDefault),
...
export const PostApiBackupsNameVerifyResponse = zod.object({
  "formatVersion": zod.int().min(postApiBackupsNameVerifyResponseFormatVersionMin).describe('Zero for legacy archives without a manifest.'),
  "encryptionVersion": zod.union([zod.literal(0),zod.literal(1),zod.literal(2),zod.literal(3)]).describe('Zero for unencrypted archives.'),
  "encrypted": zod.boolean(),
  "legacy": zod.boolean(),
  "createdAt": zod.iso.datetime({"offset":true}).optional(),
  "veilVersion": zod.string().optional(),
  "stateSchemaVersion": zod.int().min(1),
  "desiredRevision": zod.int().min(postApiBackupsNameVerifyResponseDesiredRevisionMin).describe('Desired configuration revision captured with the state and SQLite snapshot.'),
  "files": zod.array(zod.object({
  "name": zod.enum(['state.json', 'state.key', 'veil.db']),
  "size": zod.int().min(postApiBackupsNameVerifyResponseFilesItemSizeMin),
